/*
 * ---------------------------------------------------------------------------
 * Description: Concrete save menu implementation using PagedMenuBaseUI.
...
{
    [AddComponentMenu("Tools/Save Custom Game/UI/Paged Menu/Save Menu Manager (Legacy)")]
    public class SaveMenuManager : PagedMenuBase
    {
        #region === Unity Events ===
