...
public class LoadMenuManagerTMP : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text titleLoad; // Text component that displays the title based on the current load slot.
    ...
    [SerializeField] private TMP_Text textLoad1;
    [Space(5)]
    ...
    [SerializeField] private TMP_InputField inputField; // Input field for selecting the load slot number.
