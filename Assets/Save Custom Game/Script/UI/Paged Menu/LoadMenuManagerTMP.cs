/*
 * ---------------------------------------------------------------------------
 * Description: Concrete load menu implementation using PagedMenuBaseTMP.
...
{
    [AddComponentMenu("Tools/Save Custom Game/UI/Paged Menu/Load Menu Manager (TMP)")]
    public class LoadMenuManagerTMP : PagedMenuBaseTMP
    {
        #region === Unity Events ===
